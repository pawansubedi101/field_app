...
class UserVerifiedTicket {
  ...
  factory UserVerifiedTicket.fromMap(Map<String, dynamic> map) {
    return UserVerifiedTicket(
  ...
  factory UserVerifiedTicket.fromJson(String source) => UserVerifiedTicket.fromMap(json.decode(source) as Map<String, dynamic>);
}
