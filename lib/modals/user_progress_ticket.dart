...
class UserInprogressTicket {
  ...
  factory UserInprogressTicket.fromMap(Map<String, dynamic> map) {
    return UserInprogressTicket(
  ...
  factory UserInprogressTicket.fromJson(String source) => UserInprogressTicket.fromMap(json.decode(source) as Map<String, dynamic>);
}
